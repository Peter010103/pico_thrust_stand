...
dma_channel_config tts::dma_config =
    dma_channel_get_default_config(tts::dma_channel);
...
alarm_pool_t *tts::pico_alarm_pool =
    alarm_pool_create(DMA_ALARM_NUM, PICO_TIME_DEFAULT_ALARM_POOL_MAX_TIMERS);
